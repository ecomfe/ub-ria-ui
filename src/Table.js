...
define(
    function (require) {
         ...
         * @private
         */
        var mutilSelectAllTpl = '<div class="${divClass}"> '
                                +  '<input '
                                +  'type="checkbox" '
                                +  'id="${id}" '
                                +  'class="${className}" '
         ...
         * @private
         */
        var mutilSelectTpl = '<div class="${divClass}"> '
                            +  '<input '
                            +  'type="checkbox" '
                            +  'id="${id}" '
                            +  'class="${className}" '
                ...
                content: function (item, index) {
                    var data = {
                        ...
                        checked: isRowSelected(table, index)
                            ? 'checked="checked"'
                            : '',
                        labelClass: getClass(table, 'label-select')
                    };
         ...
         * @private
         */
        var singleSelectTpl = '<div class="${divClass}"> '
                            +  '<input '
                            +  'type="radio" '
                            +  'id="${id}" '
                            +  'name="${name}" '
         ...
         function getSingleSelectField(table) {
            return {
                ...
                content: function (item, index) {
                    ...
                    var data = {
                        divClass: getClass(table, 'radio-custom'),
                        id: id + index,
                        name: id,
